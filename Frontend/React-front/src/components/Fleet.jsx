...
export default function Fleet() {
  return (
    <div className="loadswift-card">
      <h3 style={{ fontWeight: '700', marginBottom: '20px' }}>Vehicle Registry</h3>
      <table className="loadswift-table">
        <thead>
          <tr><th>REGISTRATION NO.</th><th>ASSET MODEL</th><th>STATUS</th></tr>
        </thead>
        <tbody>
          <tr><td>VAN-05</td><td>Transporter</td><td><span className="status-badge" style={{background: 'var(--badge-available)'}}>Available</span></td></tr>
        </tbody>
      </table>
    </div>
  );
